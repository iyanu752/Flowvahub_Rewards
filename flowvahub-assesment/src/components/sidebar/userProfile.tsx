      ...
      {menuOpen && !collapsed && (
        <div className="absolute bottom-full left-4 right-4 mb-2 bg-white rounded-lg shadow-lg border border-purple-500 py-2 z-50">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 border rounded-lg text-left text-red-600 transition-colors hover:bg-red-50 hover:text-red-700 focus:outline-none"
          >
